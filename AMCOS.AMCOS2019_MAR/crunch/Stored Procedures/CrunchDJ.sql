...
CREATE PROCEDURE [crunch].[CrunchDJ] @AmcosVersionId INT = -1
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianBasePay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianLocalityPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianMedicalPremiumPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianCashAwardsPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEGLI('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEHB('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareRetirement('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianNonForeignCOLA('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOtherBenefits('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOverseasAllowances('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianHazardousDutyPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPhysicianComparabilityPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostDifferentialPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianSupervisorySpecialPay('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFICA('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianTraining('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementHealth('DJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementLifeInsurance('DJ');
    END;
