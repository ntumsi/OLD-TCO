...
CREATE PROCEDURE [web].[GetAmcosLiteCostsGSSpecialPay]
...
BEGIN
    ...
    (
        ...
        Locality BIT NULL,
        SpecialRateTableNumber VARCHAR(4) NULL,
    ...
    FROM data.Costs Costs
        INNER JOIN lookup.CostSummaryElement CSE
            ON Costs.CostElementId = CSE.CostElementId
    ...
    BEGIN
        ...
        SELECT Grade,
               ...
               MinimumPay,
               MaximumPay
        FROM web.GetMinMaxPay('GSS', @CategoryGroupCode, @CategorySubgroupCode, NULL, @SpecialRateTableNumber);
    END;
