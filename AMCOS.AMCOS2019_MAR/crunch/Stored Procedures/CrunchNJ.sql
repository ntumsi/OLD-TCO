...
CREATE PROCEDURE [crunch].[CrunchNJ] @AmcosVersionId INT = -1
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianBasePay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianLocalityPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianMedicalPremiumPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianCashAwardsPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEGLI('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEHB('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareRetirement('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianNonForeignCOLA('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOtherBenefits('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOverseasAllowances('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianHazardousDutyPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPhysicianComparabilityPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostDifferentialPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianSupervisorySpecialPay('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFICA('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianTraining('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementHealth('NJ');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementLifeInsurance('NJ');
    END;
