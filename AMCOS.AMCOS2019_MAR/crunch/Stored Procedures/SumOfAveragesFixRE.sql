...
CREATE PROCEDURE [crunch].[SumOfAveragesFixRE] @CrunchTime SMALLDATETIME
AS
BEGIN

    DECLARE @PayPlan NVARCHAR(3) = N'RE';
   ...
   For each weapon system, also insert a zero amount row */
    ...
    (
        ...
        WHERE a.CategoryGroupCode = CMF
              AND a.CategorySubgroupCode = MOS
