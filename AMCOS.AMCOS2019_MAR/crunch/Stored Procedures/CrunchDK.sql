...
CREATE PROCEDURE [crunch].[CrunchDK] @AmcosVersionId INT = -1
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianBasePay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianLocalityPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianMedicalPremiumPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianCashAwardsPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEGLI('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEHB('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareRetirement('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianNonForeignCOLA('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOtherBenefits('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOverseasAllowances('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianHazardousDutyPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPhysicianComparabilityPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostDifferentialPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianSupervisorySpecialPay('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFICA('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianTraining('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementHealth('DK');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementLifeInsurance('DK');
    END;
