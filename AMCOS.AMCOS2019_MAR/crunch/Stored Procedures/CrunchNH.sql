...
CREATE PROCEDURE [crunch].[CrunchNH] @AmcosVersionId INT = -1
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianBasePay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianLocalityPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianMedicalPremiumPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianCashAwardsPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEGLI('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFEHB('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareRetirement('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianNonForeignCOLA('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOtherBenefits('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianOverseasAllowances('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianHazardousDutyPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPhysicianComparabilityPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostDifferentialPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianSupervisorySpecialPay('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianEmployerShareFICA('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianTraining('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementHealth('NH');
        ...
        SELECT PayPlan,
               ...
               PersonnelNumber,
               Amount
        FROM crunch.CivilianPostRetirementLifeInsurance('NH');
    END;
