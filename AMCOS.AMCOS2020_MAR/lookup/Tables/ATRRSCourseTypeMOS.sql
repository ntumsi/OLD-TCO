CREATE TABLE [lookup].[ATRRSCourseTypeMOS] (
    [ATRRS_SchoolCode]     NVARCHAR (4)  NOT NULL,
    [ATRRS_CourseNumber]   NVARCHAR (50) NOT NULL,
    ...
    CONSTRAINT [PK_ATRRSCourseTypeMOS] PRIMARY KEY CLUSTERED ([ATRRS_SchoolCode] ASC, [ATRRS_CourseNumber] ASC, [AmcosVersionId] ASC)
);
