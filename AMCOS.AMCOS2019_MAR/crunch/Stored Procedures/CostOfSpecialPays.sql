...
BEGIN
    ...
    BEGIN
        ...
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'AE'
              );
        DELETE FROM crunch.Costs_RE
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'RE'
              );
        DELETE FROM crunch.Costs_NE
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'NE'
              );
        DELETE FROM crunch.Costs_AO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'AO'
              );
        DELETE FROM crunch.Costs_RO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'RO'
              );
        DELETE FROM crunch.Costs_NO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'NO'
              );
        DELETE FROM crunch.Costs_AWO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'AWO'
              );
        DELETE FROM crunch.Costs_RWO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'RWO'
              );
        DELETE FROM crunch.Costs_NWO
        WHERE CostElementId IN
              (
                  SELECT CostElementId FROM #DMDCSpecialPayProcessed WHERE PayPlan = 'NWO'
              );
